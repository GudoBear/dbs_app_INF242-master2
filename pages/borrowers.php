...
// 5. Insert into Borrowuser mapping(linking) table
...
// 4. Insert into Borrowers table and get a new borrower_id
  ...
  $addressCreateMessage = 'Address created Succesfully';
...
<script>
  ...
  const createStatus1 = <?php echo json_encode($addressCreateStatus)?>;
  const createMessage1 = <?php echo json_encode($addressCreateMessage)?>;
